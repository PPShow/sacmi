...
public class ReceitaItem implements Serializable {
	...
	@Column(name="VALOR_RECEBIDO", precision=6, scale=2, nullable=false)
	private BigDecimal valorRecebido;
	
	@Column(name="VALOR_DESCONTO", precision=2, scale=2, nullable=true)
	private BigDecimal valorDesconto;
	
	@Column(name="VALOR_LIQUIDO", precision=6, scale=2, nullable=true)
	private BigDecimal valorLiquido;
	
	@Column(name="FLAG_RECEBIMENTO_PENDENTE", nullable=true)
	...
	public ReceitaItem(Long id, Receita receita, Character categoria, BigDecimal valorRecebido) {
		...
		if(receita != null) {
			this.dataPrevistaEntrada = receita.getDataCriacao();
			this.dataEntrada = receita.getDataCriacao();
		}
	}
